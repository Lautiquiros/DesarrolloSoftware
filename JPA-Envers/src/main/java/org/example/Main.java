...
public class Main {
    public static void main(String[] args) {
        ...
        /*    Domicilio domicilio = Domicilio.builder().nombreCalle("carrillo").numero(4583).build();
            Cliente cliente = Cliente.builder()
                    .nombre("lauti")
                    .apellido("Quirós").domicilio(domicilio).build();
            domicilio.setCliente(cliente);
            Factura factura1 = Factura.builder().numero(12).fecha("15/08/2024").cliente(cliente).build();
